            ...
            <form className={classes.container}>
                <Box width={ mobDevices ? '100%' : 'auto'} display="flex" alignItems={ matches ? 'flex-start' : 'center'}  flexDirection={ matches ? 'column' : 'row'}>
                    ...
                    <Box width={ mobDevices ? '100%' : 'auto'} >
                        <TextField variant="outlined"  size="small" className={classes.textField} placeholder="Title of the event" />
                    </Box>
                </Box>
                ...
                <Box mt={3} width={ mobDevices ? '100%' : 'auto'} display="flex" alignItems={ matches ? 'flex-start' : 'center'}  flexDirection={ matches ? 'column' : 'row'}>
                    <Box width="200px" mr={3} mb={ matches ? 2 : 0 }><Typography style={{fontWeight: 600}}>Group Event:</Typography></Box>
                    <Box width={ mobDevices ? '100%' : 'auto'}>
                ...
                <Box mt={3} width={ mobDevices ? '100%' : 'auto'} display="flex" alignItems={ matches ? 'flex-start' : 'center'}  flexDirection={ matches ? 'column' : 'row'}>
                    <Box width="200px" mr={3} mb={ matches ? 2 : 0 }><Typography style={{fontWeight: 600}}>Add Timings:</Typography></Box>
                    <Box width={ mobDevices ? '100%' : 'auto'} >
                        <TimePicker/>
                    </Box>
                </Box>
                <Box mt={3} width={ mobDevices ? '100%' : 'auto'} display="flex" alignItems={ matches ? 'flex-start' : 'center'}  flexDirection={ matches ? 'column' : 'row'}>
                    <Box width="200px" mr={3} mb={ matches ? 2 : 0 }><Typography style={{fontWeight: 600}}>Link:</Typography></Box>
                    <Box width={ mobDevices ? '100%' : 'auto'} >
                ...
                <Box width={ mobDevices ? '100%' : 'auto'}  mt={3} display="flex" alignItems="flex-start"  flexDirection={ matches ? 'column' : 'row'}>
                    <Box width="200px" mr={3} mb={ matches ? 2 : 0 }  ><Typography style={{fontWeight: 600}}>Attendee connection<br/>options(select all applicable):</Typography></Box>
                    <Box width={ mobDevices ? '100%' : '300px'} >
                        <FormControlLabel
                            style={{width: 300,}}
                            control={
